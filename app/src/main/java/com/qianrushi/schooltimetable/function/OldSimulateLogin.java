...
public class OldSimulateLogin {
    ...
    private static OldSimulateLogin simulateLogin;
    private OldSimulateLogin(){
        init();
    }
    public static OldSimulateLogin getInstance(){
        if(simulateLogin==null){
            throw new IllegalStateException("Call getInstacn(Object o) to init this class.");
        }
        return simulateLogin;
    }
    public static OldSimulateLogin getInstance(Activity callback){
        if(simulateLogin==null){
            OldSimulateLogin.callback = callback;
            simulateLogin = new OldSimulateLogin();
        }
        return simulateLogin;
    }
